export const Edge = ({
  ...
  return (
    <li class='flex gap-2 items-center'>
      <span>-</span>
      <div class='group relative p-2 hover:shadow-[2px_2px_0px] shadow-black outline-black hover:outline flex justify-between items-center gap-4 has-checked:shadow-[2px_2px_0px] has-checked:outline'>
